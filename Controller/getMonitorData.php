...
$queryTabla = $conn->prepare("SELECT id_monitor, modelo_monitor, marca_monitor, serial_monitor, puertos_monitor, panel_monitor, hercios_monitor, asignado_monitor FROM monitor");
$queryTabla->execute();
