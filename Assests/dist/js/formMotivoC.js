document.getElementById("btMotivoc").addEventListener("click", () => {
    var actionc = "btMotivoc";
    var txtmotivoc = document.getElementById("txtMotivoc").value;
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    async: true,
                    data: { actionc: actionc, txtmotivoc: txtmotivoc },
